...
A new human-first walkthrough is available at `nbs/90_node_interest_rates_estimation.ipynb`.
It demonstrates node-level APR/APY estimation from historical Nyx reward events, role-assignment reconstruction, and notes on operator reward split semantics.
